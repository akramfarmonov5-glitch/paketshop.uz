...
export default function B2BAddToCartButton({
  product,
  locale,
  quantity,
  className = '',
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center gap-2 rounded-xl bg-red-600 font-semibold text-white transition hover:bg-red-700 disabled:cursor-not-allowed disabled:bg-slate-300 ${className}`}
    >
