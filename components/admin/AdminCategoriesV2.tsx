...
export default function AdminCategoriesV2() {
  ...
  return <div className="space-y-6">
    ...
    <form onSubmit={submit} className="grid gap-3 rounded-2xl border border-slate-200 bg-white p-4 md:grid-cols-2 lg:grid-cols-5">
      ...
      <button disabled={saving} className="flex items-center justify-center gap-2 rounded-xl bg-red-600 px-4 py-2.5 font-bold text-black disabled:opacity-60">{saving ? <Loader2 className="animate-spin" size={18} /> : <Plus size={18} />} Qo‘shish</button>
    </form>
